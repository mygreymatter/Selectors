...
public class RefreshingView extends ImageView {
    Bitmap bitmap;
    Paint mPaint;
    float progress;
    boolean isAnimate;
    ...
    private Bitmap getProgressBitmap() {
        ...
        if (Build.VERSION.SDK_INT > 21)
            drawable = (BitmapDrawable) this.getResources().getDrawable(R.drawable.ic_loading, null);
        else
            drawable = (BitmapDrawable) this.getResources().getDrawable(R.drawable.ic_loading);
    ...
    private Bitmap getProgress90Bitmap() {
        ...
        if (Build.VERSION.SDK_INT > 21)
            drawable = (BitmapDrawable) this.getResources().getDrawable(R.drawable.ic_loading_90, null);
        else
            drawable = (BitmapDrawable) this.getResources().getDrawable(R.drawable.ic_loading_90);
